...
const STORAGE_KEY = "aria-dashboard-theme";
...
const FONT_STORAGE_KEY = "aria-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `aria/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "aria-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-aria-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-aria-theme-font", "true");
