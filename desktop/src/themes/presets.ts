 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `aria/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "ARIA Teal",
  description: "Classic dark teal — the canonical ARIA look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" ARIA look, ported from the
 * LENS_5I overlay preset in `@vendor/ui`.
 *
 ...
 * nousnet-web's <body> is white; aria-agent's App root is `bg-black`,
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "ARIA Teal (Large)",
  description: "ARIA Teal with bigger fonts and roomier spacing",
