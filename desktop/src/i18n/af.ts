...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateARIA: "Werk ARIA op",
    updatingARIA: "Besig om ARIA op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk ARIA-inproppe op (`aria plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.aria/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.aria/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.aria/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Versamelbare ARIA-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",
      scan_subtitle:
        "ARIA-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik ARIA meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra ARIA 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "ARIA skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
