...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateARIA: "Aggiorna ARIA",
    updatingARIA: "Aggiornamento di ARIA…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin ARIA (parità con `aria plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.aria/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.aria/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.aria/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badge ARIA da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",
      scan_subtitle:
        "Scansione della cronologia delle sessioni ARIA in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa ARIA di più",
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando ARIA rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "ARIA sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",
