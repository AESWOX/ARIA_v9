...
export const pt: Translations = {
  ...
  status: {
    ...
    stopped: "Parado",
    updateARIA: "Atualizar ARIA",
    updatingARIA: "A atualizar ARIA…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descobrir, instalar, ativar e atualizar plugins ARIA (paridade com `aria plugins`).",
    ...
    removeConfirm: "Remover este plugin de ~/.aria/plugins/?",
    removeHint: "Apenas plugins instalados pelo utilizador em ~/.aria/plugins podem ser removidos.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "Nenhuma competência encontrada. As competências são carregadas de ~/.aria/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Distintivos colecionáveis do ARIA obtidos a partir do histórico real de sessões. Conquistas conhecidas mas ainda não obtidas aparecem como Descobertas; conquistas Secretas permanecem ocultas até surgir o primeiro comportamento correspondente.",
      scan_subtitle:
        "A analisar o histórico de sessões do ARIA. A primeira análise pode demorar 5–10 segundos em históricos extensos.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Mais recente",
      latest_hint_empty: "execute mais o ARIA",
    ...
    guide: {
      ...
      secret_body:
        "As secretas escondem o seu acionador exato. Assim que o ARIA detetar um sinal relacionado, o cartão passa a Descoberta e mostra o requisito.",
      scan_status_header: "Estado da análise",
      scan_status_body:
        "O ARIA analisa o histórico local uma vez e depois os cartões aparecem automaticamente. Nada está bloqueado se isto demorar alguns segundos.",
