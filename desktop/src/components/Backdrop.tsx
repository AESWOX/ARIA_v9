import { useGpuTier } from "@vendor/ui/hooks/use-gpu-tier";

import fillerBgUrl from "@vendor/ui/assets/filler-bg0.webp";

/**
 * Replicates the visual layer stack of `<Overlays dark />` from
 * `@vendor/ui` without pulling in its leva / gsap / three peer deps.
 *
 * See `design-language/src/ui/components/overlays/index.tsx` for the source of
 * truth. Defaults match LENS_0 (the ARIA teal dark preset); the deep canvas
