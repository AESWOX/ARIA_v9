 ...
 * `window.__ARIA_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the ARIA brand in the top bar
 ...
 *  `window.__ARIA_PLUGINS__.registerSlot(...)`.
 *
