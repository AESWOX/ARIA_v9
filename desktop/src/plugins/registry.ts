 ...
 *
 * Plugins call window.__ARIA_PLUGINS__.register(name, Component)
...
import { Card, CardHeader, CardTitle, CardContent } from "@vendor/ui/ui/components/card";
import { Input } from "@vendor/ui/ui/components/input";
import { Label } from "@vendor/ui/ui/components/label";
import { Separator } from "@vendor/ui/ui/components/separator";
import { Tabs, TabsList, TabsTrigger } from "@vendor/ui/ui/components/tabs";
 ...
 * Exposed at runtime as ``window.__ARIA_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__ARIA_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__ARIA_PLUGIN_SDK__ = {
    ...
    // window.__ARIA_SESSION_TOKEN__ directly.
    authedFetch,
