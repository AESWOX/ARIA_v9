 ...
 *
 * Values mirror aria_valid_reasoning_efforts plus `none`
 * (thinking-off). An empty/unset config value means the ARIA default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (ARIA' default when unset). */
